    ...
    public class Demo
    {
        ...
        static void Main(string[] args)
        {
            ...
            () =>
                ...
                {
                    { StratagyName.A,  () => { return new StrategyA(); } },
                    { StratagyName.B,  () => { return new StrategyB(); } }
                }
            );


            var dd = new Dictionary<Enum, Func<IStrategy>>() {

                {  StratagyName.B ,  () => new StrategyA() },



            };

            var dda = new Dictionary<string, string>()
            {
